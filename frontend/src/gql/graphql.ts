...
export type ChatFragmentFragment = { __typename?: 'Chat', _id: string, name: string, latestMessage?: (
    { __typename?: 'Message' }
    & { ' $fragmentRefs'?: { 'MessageFragmentFragment': MessageFragmentFragment } }
  ) | null } & { ' $fragmentName'?: 'ChatFragmentFragment' };

export type MessageFragmentFragment = { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, username: string, email: string } } & { ' $fragmentName'?: 'MessageFragmentFragment' };
...
export type ChatsQuery = { __typename?: 'Query', chats: Array<(
    { __typename?: 'Chat' }
    & { ' $fragmentRefs'?: { 'ChatFragmentFragment': ChatFragmentFragment } }
  )> };
